...
from pythonProject.login_window import Ui_MainWindow
from pythonProject.Registration import RegistrationWindow
from pythonProject.Site_window import SiteWindow
