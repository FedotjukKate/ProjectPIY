...
from Progect_PIY.login_window import Ui_MainWindow
from Progect_PIY.Registration import RegistrationWindow
from Progect_PIY.Site_window import SiteWindow
